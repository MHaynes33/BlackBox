...
:   This baseline model can serve as a reference point to compare the performance of other and more complex algorithms that will be developed later on
...
Target: reimbursement(expected_output)

Training data: 'public_cases' data set, since this data includes the reimbursement column
