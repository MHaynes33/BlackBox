...
## 5. Outliers or Anomaly Detected -- inconsistency across Matthew and Ayushi's Notebook, maybe?

None for individual datasets. Outliers were checked using the IQR rule and none were detected.
...
However, outliers were noticeable once the datasets were merged together:

:   Total Receipts amount was positively skewed with a few outliers

:   Reimbursement amount had a continuous distribution with a few high-end outliers
