...
`private_cases` : 1000 rows x 3 columns
...
\~ note: rows are the instances and columns are: trip_duration_days, miles_traveled, total_receipts_amount, and expected_output (only on public cases).
